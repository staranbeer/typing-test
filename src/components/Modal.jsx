        ...
        ReactDOM.createPortal(
          <div className="modal-container">
            <div
              ...
              onClick={toggleModal}
            ></div>
            <div className="modal z-30 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-12 py-16 pt-20 rounded-md  dark:border-2  dark:text-white font-monofett  text-center w-96">
              <div
                onClick={toggleModal}
